...
.home {
  ...
  .hands-photos {
    ...
    #photosHover:hover > .hidden,
    #photosHover-left:hover > .hidden {
      color: #3a76b8;
      left: 0;
      transition: all 0.5s;
      z-index: 888;
    }
    #photosHover:hover > .absolute-title,
    #photosHover-left:hover > .absolute-title {
      transition: all 0.5s;
      opacity: 1;
    }
    #photosHover-left > .hidden {
      left: -100%;
    }
  }
