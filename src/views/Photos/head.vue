  ...
  <div class="hello">
    <div class="flex">
      <div class="flex-div left" ref="left">
        <p v-for="(item, index) in chaifenData.left" :key="index"><img :src="item" /></p>
      </div>
      <div class="flex-div center" ref="center">
        <p v-for="(item, index) in chaifenData.center" :key="index"><img :src="item" /></p>
      </div>
      <div class="flex-div right" ref="right">
        <p v-for="(item, index) in chaifenData.right" :key="index"><img :src="item" /></p>
      </div>
    </div>
  </div>
</template>
