      ...
      <el-col :span="14" :offset="2">
        ...
        <el-row>
          ...
          <h4
            ...
            v-if="queryInfo.offset === 0 && mvHotComment.length !== 0"
          >
            精彩评论
          </h4>
          <!--精彩评论的信息-->
          ...
          <div
            v-for="(item, index) in mvCommentList"
            :key="index"
            style="position: relative;border-top: 1px solid rgb(240,240,242);
      ...
      <el-col :span="7" :offset="1">
        ...
        <el-row style="margin-top: 10px;margin-left: 12px;">
          ...
          <span style="font-size: 14px;margin-left: 15px;float: right"
            >播放次数:
            <span style="font-size: 14px;">{{
              (mvDetailInfo.data.playCount / 10000).toFixed(0) + "万次"
            }}</span>
          </span>
        </el-row>
        ...
        >
          ...
          <el-col :span="10" :offset="1">
            ...
            <div style="margin-left: 55px;margin-top: -19px;line-height:20px">
              <span style="cursor: pointer" @click="toMvPage(item.id)">{{
                item.name
              }}</span>
...
export default {
  ...
  methods: {
    ...
    getMvDetailInfo() {
      this.$http
        .get("/mv/detail", { params: { mvid: this.curMvId } })
        .then((res) => {
    ...
    getSimiMvs() {
      this.$http
        .get("simi/mv", { params: { mvid: this.curMvId } })
        .then((res) => {
